...
$site_top = "http://www.inet-do.co.jp";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "k-imai@inet-do.co.jp";
...
$Referer_check_domain = "inet-do.co.jp";
...
$refrom_name = "インターネット北海道";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "応募フォームからのメール送信ありがとうございました";
...
───────────────────────────────────────────────
インターネット北海道
〒060-0061 札幌市中央区南１条西８丁目６番地２　
TEL：011-213-1688 　FAX：011-213-1677
E-mail:imai@inet-do.co.jp
URL: http://www.inet-do.co.jp
───────────────────────────────────────────────
